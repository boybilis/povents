...
ob_start(static function (string $html): string {
    ...
    $html = str_replace(['assets/responsive.css?v=15','assets/responsive.css?v=16','assets/responsive.css?v=17'], 'assets/responsive.css?v=18', $html);
