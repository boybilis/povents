...
ob_start(static function (string $html): string {
    ...
    if (str_contains($html, '<body class="camera-page">')) $html = str_replace('</head>', '<link rel="stylesheet" href="assets/camera-orientation.css?v=2"></head>', $html);
    $html = str_replace(
