...
function download_photo_album(array $event, bool $shared = false, ?string $coverDataUri = null): never {
    ...
    echo '<style>.page-surface{position:absolute;inset:0;overflow:hidden;padding:clamp(14px,3vw,38px);background:#f7f1e4;color:#17231f;box-shadow:inset 18px 0 28px #8d806522}.blank-page .page-surface{background:#151916;box-shadow:none}.cover .page-surface{display:grid;place-items:center;text-align:center;color:#fff;background:linear-gradient(145deg,#113f31,#071c16)}.page-surface>.grid{height:calc(100% - 58px)}@media(max-width:700px){.page-surface{padding:10px 10px 115px}.page-surface>.grid{height:calc(100% - 46px)}}</style>';
