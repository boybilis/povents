...
function download_photo_album(array $event): never {
    ...
    echo '<style>.page:not(.cover){grid-template-rows:minmax(0,1fr)}.grid{width:100%;height:100%;min-width:0;min-height:0;overflow:hidden}.photo{display:flex;align-items:center;justify-content:center;min-width:0;min-height:0;overflow:hidden}.photo img{width:100%;height:100%;max-width:100%;max-height:100%;object-fit:contain}</style>';
