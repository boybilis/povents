...
function download_photo_album(array $event, bool $shared = false, ?string $coverDataUri = null): never {
    ...
    echo '*{box-sizing:border-box}html,body{height:100%}body{margin:0;background:#151916;color:#eef2ef;font-family:Arial,sans-serif;overflow:hidden}.cover img{width:min(420px,70%);filter:drop-shadow(0 4px 8px #0008)}.cover h1{font-family:Georgia,serif;font-size:clamp(24px,4vw,52px);line-height:1.08;margin:16px 0 8px;overflow-wrap:anywhere}.cover p{color:#cbd8d2}.grid{display:grid;gap:clamp(8px,2vw,20px);height:100%}.photo{margin:0;display:flex;align-items:center;justify-content:center;min-width:0;min-height:0;overflow:hidden}.photo img{width:auto;height:auto;max-width:100%;max-height:100%;display:block;object-fit:contain;border:3px solid #fff;border-radius:8px;background:transparent}.controls{display:flex;align-items:center;justify-content:center;gap:12px}.controls button{border:0;border-radius:999px;padding:12px 18px;background:#dff25f;color:#10251d;font:700 15px Arial;cursor:pointer}.controls button:disabled{opacity:.35}.count{min-width:95px;text-align:center;color:#bec8c2;font-size:14px}.hint{text-align:center;color:#8f9b95;font-size:12px}</style></head><body><main class="album"><section class="book" id="book">';
